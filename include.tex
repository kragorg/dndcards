...
\newenvironment{Spell}[8]{%
  % #1: Level, #2: Casting Time, #3: Range/Area, #4: Components
  % #5: Duration, #6: School, #7: Attack/Save, #8: Damage/Effect
  %
  \begin{tabular}{p{0.22\linewidth}p{0.22\linewidth}p{0.22\linewidth}p{0.22\linewidth}}
  \head{Level}     & \head{Casting Time}  & \head{Range/Area}   & \head{Components} \\
  \smol{#1}        & \smol{#2}            & \smol{#3}           & \smol{#4} \\[0.1in]
  \head{Duration}  & \head{School}        & \head{Attack/Save}  & \head{Damage/Effect} \\
  \smol{#5}        & \smol{#6}            & \smol{#7}           & \smol{#8} \\
  \end{tabular}
